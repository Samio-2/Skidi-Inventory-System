...
if (isset($_POST["submit"])) {
    ...
    if (tambah_barang_masuk($_POST) > 0) {
                                            ...
                                            <?php foreach ($masuk as $msk) : ?>
                                                <tr class="col-12">
                                                    <td>
                                                        ...
                                                        <div class="d-inline-block f-w-700 " style="width: 17.5%">
                                                            <h6>
                                                                <?= $msk["vendor"]; ?>
                                                            </h6>
                                                        </div>
                                                        ...
                                                        <div class="d-inline-block f-w-700 " style="width: 10%">
                                                            <h6>
                                                                <a type="button" data-toggle="modal" data-target="#ubahModalid<?= $msk["id"]; ?>" data-whatever="@mdo"><i class="fa fa-edit" style="width: 20px;"></i>
                                                                </a>
                                                                <div class="modal fade ubahModalid<?= $msk["id"]; ?>" id="ubahModalid<?= $msk["id"]; ?>" tabindex="-1" aria-labelledby="ubahModalid<?= $msk["id"]; ?>Label" aria-hidden="true">
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title" id="ubahModalid<?= $msk["id"]; ?>Label">Ubah Barang Masuk</h5>
                                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                    <span aria-hidden="true">&times;</span>
                                                                                </button>
                                                                            </div>
                                                                            <div class="modal-body">
                                                                                <form action="" method="POST">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <select class="form-control " name="produk" id="produk">
                                                                                            <option value="<?= $msk['id_stok']; ?>" disabled selected><?= $msk['name']; ?></option>
                                                                                            <?php foreach ($stok as $stk) : ?>
                                                                                                <option value="<?= $stk['id']; ?>"> <?= $stk['name']; ?> </option>
                                                                                            <?php endforeach; ?>
                                                                                        </select>
                                                                                        ...
                                                                                        <input type="text" class="form-control" name="vendor" id="vendor" value="<?= $msk["vendor"]; ?>">

                                                                                        <label for="quantity" class="col-form-label">
                                                                                            Kuantitas
                                                                                        </label>
                                                                                        <input type="text" class="form-control" name="quantity" id="quantity" value="<?= $msk["quantity"]; ?>">

                                                                                        <label for="date" class="col-form-label">
                                                                                            Tanggal Masuk
                                                                                        </label>
                                                                                        <input type="date" class="form-control" name="date" id="date" value="<?= $msk["date"]; ?>">
                                                                ...
                                                                <a type="button" data-toggle="modal" data-target="#deleteModalid<?= $msk["id"]; ?>" data-whatever="@mdo">
                                                                    <i class="fa fa-trash" style="width: 20px;"></i>
                                                                </a>
                                                                <div class="modal fade deleteModalid<?= $msk["id"]; ?>" id="deleteModalid<?= $msk["id"]; ?>" tabindex="-1" role="dialog" aria-labelledby="deleteModalid<?= $msk["id"]; ?>Label" aria-hidden="true">
                                                                    <div class="modal-dialog" role="document">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title" id="deleteModalid<?= $msk["id"]; ?>Label">Delete Data</h5>
                                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                    <span aria-hidden="true">&times;</span>
                                                                                </button>
                                                                            </div>
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                ...
                                                                                <a href="delete_barang_masuk.php?id=<?= $msk["id"]; ?>" class="btn btn-danger">Delete</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
