...
$request = query("SELECT request.id, request.id_stok, stok.name, request.deskripsi, request.quantity FROM request JOIN stok WHERE request.id_stok = stok.id ");
if (isset($_POST["submit"])) {

    if (tambah_request($_POST) > 0) {
        ...
        <div class="row align-items-center">
            <div class="col-md-8">
                <div class="page-header-title">
                    <h5 class="m-b-10" style="color: black;">Request Barang Keluar
                                        ...
                                        <tbody>
                                            <tr class="col-12">
                                                <td style="background-color: rgb(236, 236, 236);">
                                                    ...
                                                    <div class="d-inline-block f-w-700 " style="width: 33%">
                                                        <h6>
                                                            Kuantitas
                                                        </h6>
                                                    </div>
                                            ...
                                            <?php foreach ($request as $rqs) : ?>
                                                <tr class="col-12">
                                                    <td>
                                                        ...
                                                        <div class="d-inline-block f-w-700 " style="width: 21%">
                                                            <h6>
                                                                <?= $rqs["deskripsi"]; ?>
                                                            </h6>
                                                        </div>
                                                        ...
                                                        <div class="d-inline-block f-w-700 " style="width: 10%">
                                                            <h6>
                                                                <a type="button" data-toggle="modal" data-target="#ubahModalid<?= $rqs["id"]; ?>" data-whatever="@mdo"><i class="fa fa-edit" style="width: 20px;"></i>
                                                                </a>
                                                                <div class="modal fade ubahModalid<?= $rqs["id"]; ?>" id="ubahModalid<?= $rqs["id"]; ?>" tabindex="-1" aria-labelledby="ubahModalid<?= $rqs["id"]; ?>Label" aria-hidden="true">
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title" id="ubahModalid<?= $rqs["id"]; ?>Label">Ubah Barang Masuk</h5>
                                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                    <span aria-hidden="true">&times;</span>
                                                                                </button>
                                                                            </div>
                                                                            <div class="modal-body">
                                                                                <form action="" method="POST">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <select class="form-control " name="produk" id="produk">
                                                                                            <option value="<?= $rqs['id_stok']; ?>" disabled selected><?= $rqs['name']; ?></option>
                                                                                            <?php foreach ($stok as $stk) : ?>
                                                                                                <option value="<?= $stk['id']; ?>"> <?= $stk['name']; ?> </option>
                                                                                            <?php endforeach; ?>
                                                                                        </select>
                                                                                        ...
                                                                                        <input type="text" class="form-control" name="deskripsi" id="deskripsi" value="<?= $rqs["deskripsi"]; ?>">

                                                                                        <label for="quantity" class="col-form-label">
                                                                                            Kuantitas
                                                                                        </label>
                                                                                        <input type="text" class="form-control" name="quantity" id="quantity" value="<?= $rqs["quantity"]; ?>">
                                                                ...
                                                                <a type="button" data-toggle="modal" data-target="#deleteModalid<?= $rqs["id"]; ?>" data-whatever="@mdo">
                                                                    <i class="fa fa-trash" style="width: 20px;"></i>
                                                                </a>
                                                                <div class="modal fade deleteModalid<?= $rqs["id"]; ?>" id="deleteModalid<?= $rqs["id"]; ?>" tabindex="-1" role="dialog" aria-labelledby="deleteModalid<?= $rqs["id"]; ?>Label" aria-hidden="true">
                                                                    <div class="modal-dialog" role="document">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title" id="deleteModalid<?= $rqs["id"]; ?>Label">Delete Data</h5>
                                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                    <span aria-hidden="true">&times;</span>
                                                                                </button>
                                                                            </div>
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                ...
                                                                                <a href="delete_request.php?id=<?= $rqs["id"]; ?>" class="btn btn-danger">Delete</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
